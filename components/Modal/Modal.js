...
function Modal() {
  ...
  const uploadPost = async () => {
    ...
    //4) get a download URL from fb storage and update the original firestore post with image
    ...
    // you can do this as const snapshot = await uploadString
    ...
    //close recoil local storage, hence (i think) the modal closes down
    setOpen(false);
              ...
              <div>
                {selectedFile ? (
                  ...
                  <div
                    ...
                    className="mx-auto flex items-center justify-center bg-red-100 h-12 w-12
